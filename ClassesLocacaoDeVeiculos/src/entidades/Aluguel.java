...
public class Aluguel {
	...
	public Aluguel(int id_aluguel, int id_cliente_aluguel, String placa, String nome, LocalDate data_aluguel,
	...
	public String toString() {
		return "Aluguel [id_aluguel=" + id_aluguel + ", id_cliente_aluguel=" + id_cliente_aluguel + ", placa=" + placa
				+ ", nome=" + nome + ", data_aluguel=" + data_aluguel + ", data_retorno=" + data_retorno + ", taxa="
				+ taxa + "]";
	}
